...
const ScheduleTable = () => {
  ...
  return (
    <div className="container mx-auto my-[50px] px-4">
          ...
          <thead className="bg-blue-600 text-white">
            <tr>
              ...
              {fields.map((field, index) => (
                <th key={index} className="px-4 py-10 ">
                  {field}
                </th>
              ))}
            </tr>
          ...
          <tbody>
            {hours.map((hour, hourIdx) => (
              <tr key={hourIdx} className="border-b border-gray-300">
                <td className="px-4 py-10 font-semibold">{hour}</td>
      ...
      {/* Hiển thị tổng tiền */}
      <div className="flex justify-between items-center bg-gray-100 p-4 rounded-lg shadow mt-[50px] ">
        <div>
